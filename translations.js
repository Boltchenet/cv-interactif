const translations = {
    common: {
        about: { en: "About Me", fr: "À propos de moi", cn: "关于我" },
        contact: { en: "Contact", fr: "Contact", cn: "联系方式" },
        phone: { en: "Phone", fr: "Téléphone", cn: "电话" },
        view: { en: "View", fr: "Voir", cn: "查看" },
        home: { en: "Home", fr: "Accueil", cn: "首页" }
    },
    index: {
        welcome: { en: "Welcome to My Interactive CV", fr: "Bienvenue sur mon CV dynamique", cn: "欢迎来到我的交互式简历" },
        subtitle: { en: "Data Enthusiast | Music Lover | Creative Thinker", fr: "Data Scientist | Musicien | Créatif", cn: "数据专家 | 音乐迷 | 创意思考者" },
        explore: { en: "Explore More", fr: "En découvrir plus", cn: "探索更多" }
    },
    categories: {
        title: { en: "Explore My Universe", fr: "Découvrez mon univers", cn: "探索我的世界" },
        subtitle: { en: "Discover my different areas of expertise", fr: "Découvrez mes différents domaines d'expertise", cn: "探索我的专业领域" }
    },
    cards: {
        data: {
            title: { en: "Data Science", fr: "Science des données", cn: "数据科学" },
            button: { en: "View Projects", fr: "Voir les projets", cn: "查看项目" },
            skills: {
                ...
                software: { en: "Software", fr: "Outils logiciels", cn: "软件" },
                software_desc: { en: "Tools and software I use", fr: "Outils et logiciels utilisés", cn: "我使用的工具和软件" },
                stats: { en: "Statistics", fr: "Statistiques", cn: "统计" },
                stats_desc: { en: "My statistical skills", fr: "Mes compétences en statistiques", cn: "我的统计技能" },
        ...
        music: {
            ...
            button: { en: "Discover More", fr: "En savoir plus", cn: "了解更多" },
            skills: {
                journey: { en: "Journey", fr: "Parcours", cn: "历程" },
                journey_desc: { en: "My musical evolution", fr: "Mon évolution ", cn: "我的音乐历程" },
                competitions: { en: "Competitions", fr: "Compétitions musicales", cn: "参赛经历" },
                competitions_desc: { en: "My performances", fr: "Mes performances", cn: "我的比赛经历" },
                instruments: { en: "Skills", fr: "Compétences", cn: "技能" },
                instruments_desc: { en: "Instruments mastered", fr: "Instruments maîtrisés", cn: "擅长的乐器" },
                portfolio: { en: "Portfolio", fr: "Portfolio", cn: "作品集" },
                portfolio_desc: { en: "Listen to my work", fr: "Écoutez mes créations", cn: "聆听我的作品" }
            }
        },
        other: {
            ...
            skills: {
                writing: { en: "Author", fr: "Auteur", cn: "写作" },
                writing_desc: { en: "My writing projects", fr: "Mes projets d'écriture", cn: "我的写作项目" },
                gaming: { en: "Gaming", fr: "Jeux vidéo", cn: "电子游戏" },
                gaming_desc: { en: "My gaming universe", fr: "Mes passions numériques", cn: "我的游戏世界" },
                travel: { en: "Travel", fr: "Voyages", cn: "旅行" },
                travel_desc: { en: "My adventures", fr: "Mes aventures", cn: "我的旅行经历" },
    ...
    titles: {
        ...
        music: { en: "Musical World", fr: "Univers musical", cn: "音乐世界" },
    ...
    data: {
        ...
        skills: {
            ...
            access_desc: { en: "Databases", fr: "Gestion de bases de données", cn: "数据库" },
            stats: { en: "Statistics", fr: "Statistiques", cn: "统计" },
            stats1: { en: "Descriptive stats", fr: "Statistiques descriptives", cn: "描述性统计" },
            stats2: { en: "Inferential stats", fr: "Statistiques inférentielles", cn: "推论统计" },
            stats3: { en: "Data cleaning", fr: "Prétraitement de données", cn: "数据清洗" },
        ...
        projects: {
            ...
            happiness: {
                title: { en: "Happiness", fr: "Indice de bonheur", cn: "幸福指数" },
    ...
    other: {
        ...
        subtitle: { en: "My other worlds of passion and creativity", fr: "Mes autres univers de passion et créativité", cn: "我的其他兴趣与创意世界" },
        passions: {
            basketball: {
                title: { en: "Streetball Player", fr: "Basket de rue", cn: "街头篮球运动员" },
                desc: { en: "5 years of urban basketball — agility, teamwork, and improvisation are my game. Regular player on Paris courts with a competitive mindset.", 
                       fr: "5 ans de basketball urbain — l'agilité, l'esprit d'équipe et l'improvisation sont mes atouts. Joueur régulier sur les terrains parisiens avec un esprit compétitif.", 
                       cn: "5年街头篮球经验——以敏捷、团队合作和即兴发挥见长。经常在巴黎球场打球，具有竞争意识。" },
                tags: {
                    1: { en: "Pick-up games", fr: "Matchs de pick-up", cn: "即兴比赛" },
                    2: { en: "Paris spots", fr: "Terrains parisiens", cn: "巴黎球场" },
                    3: { en: "Competitive", fr: "Compétitif", cn: "竞技" }
                }
            },
            gaming: {
                title: { en: "Competitive Gamer", fr: "Joueur compétitif", cn: "竞技游戏玩家" },
                desc: { en: "Strategy and reflexes honed through e-sports titles — where analytics meet adrenaline. Focused on ranked play and team coordination.", 
                       fr: "Stratégie et réflexes affûtés à travers les jeux e-sports. Concentré sur le jeu classé et la coordination d'équipe.", 
                       cn: "通过电竞游戏磨练策略和反应能力——在分析与激情中寻找平衡。专注于排名赛和团队配合。" },
                tags: {
                    1: { en: "MOBAs", fr: "MOBAs", cn: "MOBAs" },
                    2: { en: "FPS", fr: "FPS", cn: "FPS" },
                    3: { en: "Leaderboards", fr: "Classements", cn: "排行榜" }
                }
            },
            travel: {
                title: { en: "Global Explorer", fr: "Voyageur", cn: "环球旅行者" },
                desc: { en: "From New York's skyscrapers to China's ancient ruins — collecting cultural perspectives across continents. Next destination: Japan.", 
                       fr: "Entre modernité new-yorkaise et histoire chinoise. Prochaine destination: le Japon.", 
                       cn: "从纽约的摩天大楼到中国的古代遗址——收集不同大陆的文化视角。下一站：日本。" },
                tags: {
            ...
            ux: {
                ...
                desc: { en: "Approved tester on UserTesting — shaping digital experiences through rigorous analysis. Bridging tech and human-centered design.", 
                       fr: "Expert UX sur UserTesting — j'évalue les interfaces pour des designs plus intuitifs, combinant rigueur technique et besoins des commanditaires", 
                       cn: "UserTesting认证测试员——通过严格分析塑造数字体验。连接技术与以人为本的设计。" },
                tags: {
                    1: { en: "UserTesting", fr: "UserTesting", cn: "用户体验测试" },
        ...
        timeline: {
            "2009": {
                ...
                desc: { en: "Started learning at age 6 with private teacher Mrs Liu", 
                       fr: "A commencé le piano à 6 ans avec le professeur particulier Mme Liu", 
                       cn: "6岁开始跟随刘老师学习钢琴" }
            },
            "2015": {
            ...
            "2021": {
                title: { en: "2021 - Cycle 3 Completion", fr: "2021 - Fin du cycle 3", cn: "2021年 - 完成第三阶段" },
                desc: { en: "Reached advanced level before pursuing other paths", 
                       fr: "A atteint un niveau avancé avant de s'ouvrir à d'autres voies", 
                       cn: "在转向其他领域前达到高级水平" }
            },
            "2023": {
                title: { en: "2023 - Composition Era", fr: "2023 - Période de composition", cn: "2023年 - 创作时期" },
        ...
        skills: {
            ...
            composition: {
                ...
                desc: { en: "Creating original music with FL Studio", 
                       fr: "Création de musique avec FL Studio", 
    ...
    about: {
        ...
        sections: {
            who: {
                title: { en: "Who I Am", fr: "Qui suis-je", cn: "我是谁" },
                content: { 
                    en: "Hi, I'm Hugo MA, a first-year student in the Bachelor of Technology (B.U.T.) in Data Science. ",
                    fr: "Bonjour, je suis Hugo MA, étudiant en première année de Bachelor Universitaire de Technologie (B.U.T.) en Science des Données.",
